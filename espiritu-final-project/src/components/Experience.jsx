      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg group">
          <a href="projects/TributePage/index.html" target="_blank" rel="noopener noreferrer">
            <img src="src/components/img/w1.png" alt="Tribute Page" className="w-full h-48 object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105" />
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg group">
          <a href="projects/SurveyForm/index.html" target="_blank" rel="noopener noreferrer">
            <img src="src/components/img/w3.png" alt="Survey Form" className="w-full h-48 object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="text-center text-white px-4 py-2">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg group">
          <a href="projects/ProductLandingPage/index.html" target="_blank" rel="noopener noreferrer">
            <img src="src/components/img/w4.png" alt="Product Landing Page" className="w-full h-48 object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="text-center text-white px-4 py-2">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg group">
          <a href="projects/TechnicalDocumentation/index.html" target="_blank" rel="noopener noreferrer">
            <img src="src/components/img/w2.png" alt="Technical Documentation Page" className="w-full h-48 object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="text-center text-white px-4 py-2">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg group">
          <a href="projects/Rhizalyn Website/index.html" target="_blank" rel="noopener noreferrer">
            <img src="src/components/img/w5.png" alt="Personal Webpage" className="w-full h-48 object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="text-center text-white px-4 py-2">
